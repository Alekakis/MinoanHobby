...
const STOCK_KEY = 'product:stock:euroleague';
const HOLD_PREFIX = 'SELECT:euroleague-mega-box:hold';
const HOLD_INDEX_KEY = 'SELECT:euroleague-mega-box:holdIndex';
const HOLD_COUNT_KEY = 'SELECT:euroleague-mega-box:holdCount';
const SOLD_COUNT_KEY = 'SELECT:euroleague-mega-box:soldCount';
const MAX_STOCK = 10;
    ...
    try {
        ...
        if (req.method === 'POST') {
            ...
            if (action === 'reserve') {
                ...
                const newQty = (parseInt(existing || '0', 10) || 0) + requested;
