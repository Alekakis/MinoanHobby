...
const STOCK_KEY = 'SELECT:random-small-combo-euroleague:stock';
const HOLD_PREFIX = 'SELECT:random-small-combo-euroleague:hold';
const HOLD_INDEX_KEY = 'SELECT:random-small-combo-euroleague:holdIndex';
const HOLD_COUNT_KEY = 'SELECT:random-small-combo-euroleague:holdCount';
const SOLD_COUNT_KEY = 'SELECT:random-small-combo-euroleague:soldCount';
const MAX_STOCK = 50;
const HOLD_TTL = 10 * 60; // 10 minutes
