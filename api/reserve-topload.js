...
const STOCK_KEY = 'SELECT:topload:stock';
const HOLD_PREFIX = 'SELECT:topload:hold';
const HOLD_INDEX_KEY = 'SELECT:topload:holdIndex';
const HOLD_COUNT_KEY = 'SELECT:topload:holdCount';
const SOLD_COUNT_KEY = 'SELECT:topload:soldCount';
const MAX_STOCK = 50;
