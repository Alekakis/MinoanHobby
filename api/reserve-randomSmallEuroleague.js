...
const STOCK_KEY = 'SELECT:random-small-euroleague:stock';
const HOLD_PREFIX = 'SELECT:random-small-euroleague:hold';
const HOLD_INDEX_KEY = 'SELECT:random-small-euroleague:holdIndex';
const HOLD_COUNT_KEY = 'SELECT:random-small-euroleague:holdCount';
const SOLD_COUNT_KEY = 'SELECT:random-small-euroleague:soldCount';
const MAX_STOCK = 30;
