...
const STOCK_KEY = 'SELECT:thickcard:stock';
const HOLD_PREFIX = 'SELECT:thickcard:hold';
const HOLD_INDEX_KEY = 'SELECT:thickcard:holdIndex';
const HOLD_COUNT_KEY = 'SELECT:thickcard:holdCount';
const SOLD_COUNT_KEY = 'SELECT:thickcard:soldCount';
const MAX_STOCK = 50;
