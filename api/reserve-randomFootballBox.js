...
const STOCK_KEY = 'SELECT:random-football-box:stock';
const HOLD_PREFIX = 'SELECT:random-football-box:hold';
const HOLD_INDEX_KEY = 'SELECT:random-football-box:holdIndex';
const HOLD_COUNT_KEY = 'SELECT:random-football-box:holdCount';
const SOLD_COUNT_KEY = 'SELECT:random-football-box:soldCount';
const MAX_STOCK = 30;
